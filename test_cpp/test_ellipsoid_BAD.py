...
# print(DOC.ellipsoid_F(p_rimon_xtensor, a, A))
# print()

# print(SF.F_dp(p_rimon_torch, A_torch, a_torch))
# print(DOC.ellipsoid_dp(p_rimon_xtensor, a, A))
# print()

# print(SF.F_dpdp(p_rimon_torch, A_torch, a_torch))
# print(DOC.ellipsoid_dpdp(A))
# print()

# print(SF.F_dpdpdp(p_rimon_torch, A_torch, a_torch))
# print(DOC.ellipsoid_dpdpdp())
# print()

# print(SF.F_dx(p_rimon_torch, A_torch, a_torch))
# print(DOC.ellipsoid_dy(p_rimon_xtensor, a, A))
# print()

# print(SF.F_dxdx(p_rimon_torch, A_torch, a_torch)-DOC.ellipsoid_dydy(p_rimon_xtensor, a, A))
# print(DOC.ellipsoid_dydy(p_rimon_xtensor, a, A))
# print()

# print(SF.F_dpdx(p_rimon_torch, A_torch, a_torch)-DOC.ellipsoid_dpdy(p_rimon_xtensor, a, A))
# print(DOC.ellipsoid_dpdy(p_rimon_xtensor, a, A))
# print()

# print(SF.F_dpdpdx(p_rimon_torch, A_torch, a_torch)-DOC.ellipsoid_dpdpdy(A))
# print(DOC.ellipsoid_dpdpdy(A))
# print()

# print(SF.F_dpdxdx(p_rimon_torch, A_torch, a_torch)-DOC.ellipsoid_dpdydy(A))
# print(DOC.ellipsoid_dpdydy(A))
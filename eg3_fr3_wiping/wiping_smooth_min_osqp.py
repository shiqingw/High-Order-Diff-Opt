...
if __name__ == "__main__":
    ...
    for i in range(horizon):
        ...
        if (CBF_config["active"]):
            ...
            all_dx = np.zeros([1, 3], dtype=config.np_dtype)
    ...
    print("Time diff helper: ", time_diff_helper.mean())
    print("Time CBF QP: ", time_cbf_qp.mean())
    print("Time control loop: ", time_control_loop.mean())

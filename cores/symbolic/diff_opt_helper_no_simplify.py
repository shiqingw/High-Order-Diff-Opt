...
class DiffOptHelper(object):
    ...
    def build_matrices(self):
        ...
        implicit_N_dtheta = Matrix([diff(implicit_N, theta_var) for theta_var in self.theta_vars])
        implicit_b_dtheta = Matrix([diff(implicit_b, theta_var) for theta_var in self.theta_vars])
